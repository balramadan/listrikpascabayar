<template>
  <div class="mt-5 lg:my-5 h-full rounded-xl bg-white p-4 ring ring-indigo-50 sm:p-6 lg:p-8">
    <h2 class="font-bold">Pembayaran Bulan {{ bulanIni }}</h2>
    <div class="mt-5">
